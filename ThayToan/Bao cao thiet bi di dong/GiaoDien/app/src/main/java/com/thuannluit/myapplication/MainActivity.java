            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (!(sohieunhanvien.isEmpty())
                        ...
                        AsyncTask asyncTask = new AsyncTask() { // (chuoi,hamxuly(void hoac string), ket qua tra ve)
                            @Override
                            // xu ly du lieu ben trong
                            protected Object doInBackground(Object[] objects) { // dung thang nay boi vi neu khi su dung nhieu tac vu thi no se chan luong chinh -> chan ket noi -> sp nhieu cho http
