    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_ins_sv:
                ...
                if (checkNull() == false) {
                    ...
                    if ((studentArrayList = dbManager.loadAllStudent(this)) == null) {
                        ...
                        Toast.makeText(this, studentArrayList.toString(), Toast.LENGTH_LONG).show();
            ...
            case R.id.btn_load_sv:
                ...
                if (ma_so_lop.isEmpty() && ma_sv_4.isEmpty() && ten_sv_4.isEmpty()) {
                    ...
                    if (ma_sv_4.isEmpty() && ten_sv_4.isEmpty() ) {

                        if ((studentArrayList = dbManager.loadAllStudentByMaLop(this, ma_so_lop)) == null) {
                        } else {
                            studentArrayList = dbManager.loadAllStudentByMaLop(this, ma_so_lop);
                            studentAdapter = new StudentAdapter(ManagerStudentActivity.this,
                                    R.layout.item_student,
                                    studentArrayList);
                            lv_danhsachsv.setAdapter(studentAdapter);
